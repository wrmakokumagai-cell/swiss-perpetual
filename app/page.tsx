...
const stories = [
  {
    src: "/images/story-space.png",
    productSrc: "/images/story-product-space-clean.png",
  ...
  {
    src: "/images/story-monument.png",
    productSrc: "/images/story-product-cart-clean.png",
  ...
  {
    src: "/images/story-oyster.png",
    productSrc: "/images/story-product-oyster-clean.png",
    ...
    <main>
      ...
      <section className="hero" id="top" aria-labelledby="hero-title">
        <Image
          ...
          src="/images/equestrian-hero.png"
        ...
        <div className="hero-copy">
          ...
          <Image
            className="hero-logo"
            src="/images/rancho-wordmark.png"
      ...
      <section className="interlude" aria-label="Horsemen collaboration billboard">
        <Image
          ...
          src="/images/billboard-panel.png"
        ...
        <div className="collection-feature">
          <div className="collection-image-wrap">
            <Image
              ...
              src="/images/collaboration-feature.png"
            ...
            <Image
              ...
              src="/images/hover-space-man.png"
              alt=""
              fill
              unoptimized
              sizes="(max-width: 800px) 100vw, 66vw"
            ...
            <Image
              ...
              src="/images/hover-cart-classic.png"
              alt=""
              fill
              unoptimized
              sizes="(max-width: 800px) 100vw, 66vw"
            ...
            <Image
              ...
              src="/images/hover-oyster-sauce.png"
              alt=""
              fill
              unoptimized
              sizes="(max-width: 800px) 100vw, 66vw"
      ...
      <section className="club-visual" id="club" aria-label="Horsemen Ranch open country">
        <Image
          ...
          src="/images/open-country-club-v2.png"
